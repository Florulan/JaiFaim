...
import { getWeekDays, getMondayOfWeek, formatDayLabel } from '../lib/dates'
        ...
        <>
          <div className="flex-1 overflow-y-auto px-4 py-6 space-y-8">
            <section className="space-y-4">
              <label className="block text-sm font-semibold text-foreground">Combien de portions as-tu cuisiné ?</label>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4">
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted-foreground">Choisir les repas de la semaine</p>
              </div>
            </button>
