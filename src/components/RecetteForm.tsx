  ...
  return (
    <div className="space-y-6 pb-8">
          ...
          {RECIPE_TAGS.map((tag) => (
            <button
              ...
              className={cn(
                ...
                tags.includes(tag) ? 'bg-primary text-primary-foreground border-primary' : 'bg-card text-muted-foreground border-border'
              )}
            >
            ...
            {(['low', 'medium', 'high'] as const).map((c) => (
              <button
                ...
                className={cn(
                  ...
                  confidence === c ? 'bg-primary text-primary-foreground border-primary' : 'bg-card text-muted-foreground border-border'
                )}
              >
      ...
      <div className="flex gap-3 pt-2">
        <button type="button" onClick={onCancel} className="flex-1 py-3 rounded-2xl border border-border text-foreground font-medium text-sm">
          Annuler
        </button>
        <button
          type="button"
